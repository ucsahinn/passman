...
| --- | --- | --- | --- |
| ![Windows icon](assets/icons/windows.svg) | [PassMan-1.7.2-x64.msi](https://github.com/ucsahinn/passman/releases/latest/download/PassMan-1.7.2-x64.msi) | Installs or upgrades PassMan Server on Windows. | GitHub Release |
...
| --- | ---: | --- |
| PassMan Enterprise Vault Console | 1.7.2 | Windows MSI / Update Center |
